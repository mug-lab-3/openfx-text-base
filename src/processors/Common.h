...
inline auto getBlend2dRowPtr(const BLImageData& data, int canvasHeight, int imageOriginY, int y) -> uint32_t* {
    return reinterpret_cast<uint32_t*>(static_cast<uint8_t*>(data.pixel_data) +
